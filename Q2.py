...
# Save outputs
# cv2.imwrite('output/tree_blur_3x3_color.png', blur_3)
# cv2.imwrite('output/tree_blur_10x10_color.png', blur_10)
# cv2.imwrite('output/tree_blur_20x20_color.png', blur_20)
